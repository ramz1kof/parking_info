...
args.message = {"timestamp": str(time.time()), "sensorId": "1", "sensorType": "item-1", "numberOfAvailableCars": str(randint(0,100)), "address": str(str(randint(0, 100))), "informationOnFines": str(randint(0, 100))}
